...
describe("runaCantorPairArray", () => {
  ...
  describe("Basic functionality", () => {
    ...
    it("should decode array of single numbers back to array of pairs", () => {
      ...
      expect(result).toEqual([[1, 2], [3, 4], [5, 6]]); // Reverse Cantor pairs
    });
  ...
  describe("Perfect reversibility", () => {
    it("should be perfectly bidirectional for regular pairs", () => {
      const original = [[0, 0], [1, 1], [2, 3], [4, 2], [10, 5]];
    ...
    it("should handle large numbers", () => {
      const original = [[100, 200], [500, 1000]];
      const encoded = cantorPairArray.encode(original);
      const decoded = cantorPairArray.decode(encoded);
      expect(decoded).toEqual(original);
    });
  ...
  describe("Mathematical properties", () => {
    it("should produce unique encoding for each pair", () => {
      const pairs = [[0, 0], [0, 1], [1, 0], [1, 1], [2, 1], [1, 2]];
    ...
    it("should follow Cantor pairing formula", () => {
      ...
      const testPairs = [[0, 0], [1, 2], [3, 4], [2, 1]];
  ...
  describe("Error handling", () => {
    it("should throw on null input for encode", () => {
      expect(() => cantorPairArray.encode(null as any)).toThrow("Invalid array");
    });

    it("should throw on undefined input for encode", () => {
      expect(() => cantorPairArray.encode(undefined as any)).toThrow("Invalid array");
    });

    it("should throw on non-array input for encode", () => {
      expect(() => cantorPairArray.encode("not an array" as any)).toThrow("Invalid array");
    ...
    it("should throw on invalid pair elements", () => {
      ...
      expect(() => cantorPairArray.encode(input as any)).toThrow("Invalid pair at index 1");
    });

    it("should throw on null input for decode", () => {
      expect(() => cantorPairArray.decode(null as any)).toThrow("Invalid array");
    });

    it("should throw on undefined input for decode", () => {
      expect(() => cantorPairArray.decode(undefined as any)).toThrow("Invalid array");
    });

    it("should throw on non-array input for decode", () => {
      expect(() => cantorPairArray.decode("not an array" as any)).toThrow("Invalid array");
    ...
    it("should throw on non-number elements", () => {
      ...
      expect(() => cantorPairArray.decode(input as any)).toThrow("Invalid number at index 1");
    });
  ...
  describe("Edge cases", () => {
    it("should handle very large numbers", () => {
      const largePairs = [[1000, 2000], [5000, 3000]];
    ...
    it("should throw on negative numbers", () => {
      expect(() => cantorPairArray.encode([[-1, 2]])).toThrow("Cantor pair requires non-negative integers");
      expect(() => cantorPairArray.encode([[3, -4]])).toThrow("Cantor pair requires non-negative integers");
      expect(() => cantorPairArray.encode([[-5, 10]])).toThrow("Cantor pair requires non-negative integers");
      expect(() => cantorPairArray.encode([[0, -3]])).toThrow("Cantor pair requires non-negative integers");
    });
  ...
  describe("Real-world scenarios", () => {
    it("should encode coordinate pairs", () => {
      const coordinates = [[10, 20], [30, 40], [50, 60], [70, 80]];
    ...
    it("should handle pixel coordinates", () => {
      const pixels = [[0, 0], [100, 200], [50, 75], [255, 255]];
    ...
    it("should compress 2D index to 1D", () => {
      ...
      const indices2D = [[0, 0], [0, 1], [1, 0], [1, 1], [2, 0], [2, 1]];
    ...
    it("should handle hash key combinations", () => {
      ...
      const hashPairs = [[12345, 67890], [11111, 22222], [33333, 44444]];
